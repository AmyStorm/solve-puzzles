...
def bert_exe():
    ...
    def builditerator(filename):
        ...
        label_vocab = vocab(counter, specials=(['<unk>'])).to(device)
        ...
        data_loader = DataLoader(PandasDataset(df[['label', 'sequence', 'attention_mask', 'token_type']]),
